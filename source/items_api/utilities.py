...
def publish_message(event_type, item_id, price, effect):
    def connect():
    ...
    channel.basic_publish(exchange='', routing_key='items_queue', body=json.dumps(event), properties=pika.BasicProperties(delivery_mode=2))
