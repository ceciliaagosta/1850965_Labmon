<template>
  <div class="container d-flex align-items-center my-2">
    <div class="card shadow p-4" style="width: 100%; min-width: 400px;">
      <h2 class="mb-4 text-center">Edit Item {{ props.itemData.name }}</h2>
...
const form = ref({
  ...
  effect: props.itemData.effect,
  sprite: props.itemData.sprite
})
...
const handleSubmit = async () => {
  ...
  try {
    await itemStore.updateItem(props.itemData.id, form.value)
